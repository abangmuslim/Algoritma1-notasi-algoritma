...
<body>
    ...
    <body>
        <form method="POST" action="output.php">
            ...
            <label for="jumlah">Pilih Jumlah Perulangannya : </label><br>
            ...
            <label for="statemen">Ketikan Statemen yang akan Diulang : </label><br>
            <input type="text" name="statemen" id="statemen" required><br><br>
